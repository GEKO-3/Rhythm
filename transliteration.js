...
const specialCases = [
    ...
    { input: 'fanihedhee', output: 'ފަނިހެދީ' },{ input: 'eahhoadhaa', output: 'އެއައްހޯދާ' },
    ...
    { input: 'fahuge', output: 'ފަހުގެ' },{ input: 'rahkaa', output: 'ރައްކާ' },
    ...
    // 2 characters
    { input: 'en', output: 'އެން' },{ input: 'lo', output: 'ލޯ' },
